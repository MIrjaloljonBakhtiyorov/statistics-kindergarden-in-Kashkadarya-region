...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-[#f8fafc] font-sans overflow-x-hidden">
      ...
      <div className="relative w-full lg:w-[55%] min-h-[30vh] lg:min-h-screen bg-[#0f172a] flex items-end">
        ...
        />
        {/* Overlay - har xil viewportlar uchun optimallashtirilgan */}
        <div className="absolute inset-0 bg-gradient-to-t from-[#0f172a] via-[#0f172a]/20 lg:via-transparent to-black/20"></div>
        
        {/* Vizual Matnlar - Mobil va Desktop uchun har xil joylashuv */}
          ...
          <div className="max-w-2xl">
            ...
            <div className="hidden xs:flex items-start gap-4 p-4 sm:p-6 lg:p-8 bg-white/5 backdrop-blur-3xl rounded-2xl sm:rounded-3xl border border-white/10 shadow-2xl relative overflow-hidden group hover:bg-white/10 transition-all duration-500">
              ...
              <p className="text-white text-xs sm:text-lg lg:text-xl leading-relaxed font-medium">
                Qashqadaryo viloyati Maktabgacha boshqarmasi boshqaruv platformasi.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-[45%] flex flex-col items-center justify-center p-4 sm:p-8 lg:p-12 xl:p-20 bg-slate-50 min-h-[60vh] lg:min-h-screen">
        <div className="max-w-md w-full">
          <div className="mb-6 sm:mb-12 text-center lg:text-left">
            <div className="flex flex-col lg:flex-row items-center gap-3 sm:gap-4 mb-4 sm:mb-8">
              ...
              <div className="text-center lg:text-left">
                <h1 className="text-lg sm:text-2xl font-black text-slate-900 tracking-tight leading-none uppercase">Kashkadarya</h1>
                <p className="text-indigo-600 font-bold uppercase tracking-widest text-[8px] sm:text-[10px] mt-1">MTT Management System</p>
              </div>
            </div>
          ...
          <div className="bg-white p-5 sm:p-10 rounded-[1.5rem] sm:rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100">
            <form onSubmit={handleLogin} className="space-y-4 sm:space-y-6">
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl sm:rounded-2xl py-3.5 sm:py-5 pl-11 sm:pl-14 pr-4 sm:pr-6 text-slate-900 font-semibold text-sm sm:text-base focus:outline-none focus:ring-4 focus:ring-indigo-600/5 focus:border-indigo-600 transition-all outline-none"
                    placeholder="m_login"
                    required
                  />
                </div>
              ...
              {error && (
                <div className="bg-rose-50 border border-rose-100 text-rose-600 text-xs font-bold p-3 sm:p-4 rounded-xl text-center">
                  {error}
                </div>
              )}
          ...
          <div className="mt-8 sm:mt-12 text-center text-slate-400 font-medium">
