...
// node_modules/.pnpm/@firebase+firestore@4.14.1_@firebase+app@0.14.12/node_modules/@firebase/firestore/dist/common-7a7519be.esm.js
var User = class {
  constructor(e) {
    this.uid = e;
  }
...
var __PRIVATE_IndexEntry = class ___PRIVATE_IndexEntry {
  constructor(e, t, n, r) {
    this.hn = e, this.Pn = t, this.Tn = n, this.In = r;
  }
  /**
  ...
  En() {
    ...
    return n.set(this.In, 0), t !== e ? n.set([0], this.In.length) : ++n[n.length - 1], new ___PRIVATE_IndexEntry(this.hn, this.Pn, this.Tn, n);
  }
...
function __PRIVATE_indexEntryComparator(e, t) {
  let n = e.hn - t.hn;
  return 0 !== n ? n : (n = __PRIVATE_compareByteArrays(e.Tn, t.Tn), 0 !== n ? n : (n = __PRIVATE_compareByteArrays(e.In, t.In), 0 !== n ? n : DocumentKey.comparator(e.Pn, t.Pn)));
}
...
var __PRIVATE_IndexedDbIndexManager = class {
  ...
  xn(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r) if (this.qn(t, s.fieldPath) && isArray(e2)) r = this.Un(r, s, e2);
      else {
  ...
  jn(e, t, n, r) {
    return __PRIVATE_indexEntriesStore(e).put(r.Rn(this.uid, this.Kn(n, t.key), t.key));
  }
  Jn(e, t, n, r) {
    return __PRIVATE_indexEntriesStore(e).delete(r.An(this.uid, this.Kn(n, t.key), t.key));
  }
  Qn(e, t, n) {
    ...
    return r.ee({
      index: Oe,
      range: IDBKeyRange.only([n.indexId, this.uid, __PRIVATE_encodeKeySafeBytes(this.Kn(n, t))])
    }, ((e2, r2) => {
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  ...
  start() {
    return this.$i().then((() => {
      ...
      this.ui = true;
    })).catch(((e) => (this.qi && this.qi.close(), Promise.reject(e))));
  }
  /**
  ...
  async shutdown() {
    ...
    await this.qi.runTransaction("shutdown", "readwrite", [W, Ve], ((e) => {
  ...
  runTransaction(e, t, n) {
    ...
    let s;
    return this.qi.runTransaction(e, r, i, ((r2) => (s = new __PRIVATE_IndexedDbTransaction(r2, this.ai ? this.ai.next() : __PRIVATE_ListenSequence.ce), "readwrite-primary" === t ? this.ji(s).next(((e2) => !!e2 || this.Ji(s))).next(((t2) => {
...
async function __PRIVATE_localStoreApplyBundledDocuments(e, t, n, r) {
  ...
  for (const e2 of n) {
    const n2 = t.Ks(e2.metadata.name);
...
var __PRIVATE_BundleConverterImpl = class {
   ...
   */
  qs(e) {
    return e.metadata.exists ? __PRIVATE_fromDocument(this.serializer, e.document, false) : MutableDocument.newNoDocument(this.Ks(e.metadata.name), this.Us(e.metadata.readTime));
  }
  Us(e) {
...
var __PRIVATE_BundleLoader = class {
  constructor(e, t) {
    this.za = e, this.serializer = t, /** Batched queries to be saved into storage */
    this.ja = [], /** Batched documents to be saved into storage */
    this.Ja = [], /** The collection groups affected by this bundle. */
  ...
  Ha(e) {
    ...
    if (e.Qa.namedQuery) this.ja.push(e.Qa.namedQuery);
    ...
    } else e.Qa.document && (this.Ja[this.Ja.length - 1].document = e.Qa.document, ++t);
   ...
   */
  async Xa(e) {
    const t = await __PRIVATE_localStoreApplyBundledDocuments(e, new __PRIVATE_BundleConverterImpl(this.serializer), this.Ja, this.za.id), n = this.Za(this.documents);
    for (const t2 of this.ja) await __PRIVATE_localStoreSaveNamedQuery(e, t2, n.get(t2.name));
    return this.progress.taskState = "Success", {
      progress: this.progress,
      Ya: this.collectionGroups,
      eu: t
    };
  }
};
...
async function __PRIVATE_synchronizeViewAndComputeSnapshot(e, t) {
  ...
  return n.isPrimaryClient && __PRIVATE_updateTrackedLimbos(n, t.targetId, i.hu), i;
}
...
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  const n = __PRIVATE_debugCast(e);
  if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.Su) {
    ...
    n.Su = true, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, true);
    for (const e3 of t2) __PRIVATE_remoteStoreListen(n.remoteStore, e3);
  } else if (false === t && false !== n.Su) {
    const e2 = [];
    ...
    (function __PRIVATE_resetLimboDocuments(e3) {
      ...
      })), t3.gu.zr(), t3.fu = /* @__PURE__ */ new Map(), t3.mu = new SortedMap(DocumentKey.comparator);
    })(n), n.Su = false, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
  }
}
async function __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(e, t, n) {
  ...
  for (const e2 of t) {
    let t2;
    const n2 = r.Vu.get(e2);
    if (n2 && 0 !== n2.length) {
      t2 = await __PRIVATE_localStoreAllocateTarget(r.localStore, __PRIVATE_queryToTarget(n2[0]));
      for (const e3 of n2) {
        const t3 = r.Au.get(e3), n3 = await __PRIVATE_synchronizeViewAndComputeSnapshot(r, t3);
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r.Su) {
    for (const e2 of t) {
      if (r.Vu.has(e2) && r.sharedClientState.isActiveQueryTarget(e2)) {
    ...
    for (const e2 of n)
      r.Vu.has(e2) && // Release queries that are still active.
      await __PRIVATE_localStoreReleaseTarget(
        r.localStore,
        e2,
        /* keepPersistedTargetData */
...
function __PRIVATE_syncEngineLoadBundle(e, t, n) {
  ...
  (async function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    try {
      ...
      let s = await t2.Fu();
      for (; s; ) {
        const e3 = await i.Ha(s);
        e3 && n2._updateProgress(e3), s = await t2.Fu();
      }
      const o = await i.Xa(e2.localStore);
      ...
      })(e2.localStore, r2), n2._completeWith(o.progress), Promise.resolve(o.Ya);
    } catch (e3) {
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class extends __PRIVATE_MemoryOfflineComponentProvider {
  constructor(e, t, n) {
    super(), this.Lu = e, this.cacheSizeBytes = t, this.forceOwnership = n, this.kind = "persistent", this.synchronizeTabs = false;
  }
  async initialize(e) {
    await super.initialize(e), await this.Lu.initialize(this, e), // Enqueue writes from a previous session
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  constructor(e, t) {
    super(
      ...
      /* forceOwnership= */
      false
    ), this.Lu = e, this.cacheSizeBytes = t, this.synchronizeTabs = true;
  }
  async initialize(e) {
    await super.initialize(e);
    const t = this.Lu.syncEngine;
    ...
    await this.persistence.zi((async (e2) => {
      await __PRIVATE_syncEngineApplyPrimaryState(this.Lu.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
    }));
  }
  Mu(e) {
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    this.qu = e, this.serializer = t, /** Cached bundle metadata. */
    this.metadata = new __PRIVATE_Deferred(), /**
     * Internal buffer to hold bundle content, accumulating incomplete element
     * content.
     */
    this.buffer = new Uint8Array(), this.Uu = (function __PRIVATE_newTextDecoder() {
      return new TextDecoder("utf-8");
    })(), // Read the metadata (which is the first element).
    this.$u().then(((e2) => {
      e2 && e2.Ga() ? this.metadata.resolve(e2.Qa.metadata) : this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
             ${JSON.stringify(e2 == null ? void 0 : e2.Qa)}`));
    }), ((e2) => this.metadata.reject(e2)));
  }
  close() {
    return this.qu.cancel();
  }
  async getMetadata() {
    return this.metadata.promise;
  }
  async Fu() {
    return await this.getMetadata(), this.$u();
  }
  /**
   ...
   */
  async $u() {
    const e = await this.Wu();
    if (null === e) return null;
    const t = this.Uu.decode(e), n = Number(t);
    isNaN(n) && this.Qu(`length string (${t}) is not valid number`);
    const r = await this.Gu(n);
  ...
  async Gu(e) {
    for (; this.buffer.length < e; ) {
      await this.ju() && this.Qu("Reached the end of bundle when more is expected.");
    }
    const t = this.Uu.decode(this.buffer.slice(0, e));
    return this.buffer = this.buffer.slice(e), t;
  }
  Qu(e) {
    throw this.qu.cancel(), new Error(`Invalid bundle format: ${e}`);
  }
  /**
...
var __PRIVATE_BundleReaderSyncImpl = class {
  constructor(e, t) {
    ...
    let n = this.Fu();
    if (!n || !n.Ga()) throw new Error(`The first element of the bundle is not a metadata object, it is
         ${JSON.stringify(n == null ? void 0 : n.Qa)}`);
    this.metadata = n;
    do {
      n = this.Fu(), null !== n && this.elements.push(n);
    } while (null !== n);
  }
...
var __PRIVATE_TransactionRunner = class {
  ...
  Yu() {
    this.M_.p_((async () => {
      const e = new Transaction(this.datastore), t = this.ec(e);
      t && t.then(((t2) => {
  ...
  tc(e) {
    this.Zu > 0 && this.nc(e) ? (this.Zu -= 1, this.asyncQueue.enqueueAndForget((() => (this.Yu(), Promise.resolve())))) : this.deferred.reject(e);
  }
  nc(e) {
  ...
  return e.asyncQueue.enqueueAndForget((async () => (async function __PRIVATE_executeQueryFromCache(e2, t2, n2) {
    try {
      const r = await __PRIVATE_localStoreExecuteQuery(
        ...
        /* usePreviousResults= */
        true
      ), i = new __PRIVATE_View(t2, r.ks), s = i._u(r.documents), o = i.applyChanges(
        s,
        /* limboResolutionEnabled= */
        false
      );
  ...
  return e.asyncQueue.enqueueAndForget((async () => {
    try {
      ...
      r.resolve((async function __PRIVATE_invokeRunAggregationQueryRpc(e2, t2, n2) {
        ...
        r2.connection.Ko || delete i2.parent;
        const _ = (await r2.jo(
          "RunAggregationQuery",
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget((async () => (function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
    __PRIVATE_debugCast(e2).xa.add(t2), // Immediately fire an initial event, indicating all existing listeners
    // are in-sync.
    t2.next();
  })(await __PRIVATE_getEventManager(e), n))), () => {
    n.Ku(), e.asyncQueue.enqueueAndForget((async () => (function __PRIVATE_removeSnapshotsInSyncListener(e2, t2) {
      __PRIVATE_debugCast(e2).xa.delete(t2);
    })(await __PRIVATE_getEventManager(e), n)));
  };
}
function __PRIVATE_firestoreClientTransaction(e, t, n) {
  ...
  return e.asyncQueue.enqueueAndForget((async () => {
    const i = await __PRIVATE_getDatastore$1(e);
    new __PRIVATE_TransactionRunner(e.asyncQueue, i, n, t, r).Xu();
  })), r.promise;
}
...
// node_modules/.pnpm/@firebase+firestore@4.14.1_@firebase+app@0.14.12/node_modules/@firebase/firestore/dist/index.esm.js
...
function documentSnapshotFromJSON(t, e, n) {
  if (__PRIVATE_validateJSON(e, DocumentSnapshot._jsonSchema)) {
    ...
    const r = __PRIVATE_newSerializer(t._databaseId), s = __PRIVATE_createBundleReaderSync(e.bundle, r), a = s.Ju(), o = new __PRIVATE_BundleLoader(s.getMetadata(), r);
    for (const t2 of a) o.Ha(t2);
    const i = o.documents;
