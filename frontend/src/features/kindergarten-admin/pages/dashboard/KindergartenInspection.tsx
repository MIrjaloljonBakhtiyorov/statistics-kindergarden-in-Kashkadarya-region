    ...
    <div className="space-y-4 pb-12">
      <div className="rounded-xl bg-slate-950 text-white p-4 md:p-5 shadow-md relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-end justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-1.5 rounded-md border border-white/10 bg-white/10 px-2.5 py-1 text-[9px] font-black uppercase tracking-widest text-indigo-200 mb-2">
              <ClipboardCheck className="h-3 w-3" />
              Admin nazorati
            </div>
            <h1 className="text-2xl md:text-3xl font-black tracking-tight leading-none">Bogcha inspeksiyasi</h1>
            <p className="mt-2 max-w-2xl text-xs md:text-sm font-medium text-slate-300 leading-relaxed">
          ...
          <div className="grid grid-cols-3 gap-2 min-w-[260px]">
            {[
              ...
              <div key={item.label} className="rounded-lg border border-white/10 bg-white/10 px-3 py-2">
                ...
                <p className="mt-0.5 text-lg font-black leading-none">{item.value}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="rounded-xl border border-slate-100 bg-white p-3 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
              <label className="space-y-1">
                <span className="text-[9px] font-black uppercase tracking-widest text-slate-400">Tuman / shahar</span>
                <select
                  value={district}
                  onChange={(event) => {
              ...
              <label className="space-y-1">
                <span className="text-[9px] font-black uppercase tracking-widest text-slate-400">Search</span>
            ...
            <div className="mt-3 max-h-[360px] overflow-y-auto custom-scrollbar space-y-1.5 pr-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
            <div className="rounded-xl border border-slate-100 bg-white p-3 shadow-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-2">
                ...
                <label className="space-y-1">
                  <span className="text-[9px] font-black uppercase tracking-widest text-slate-400">Dalolatnoma raqami</span>
                  <input
                    value={actNumber}
            ...
            <div className="rounded-xl border border-slate-100 bg-white p-3 shadow-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {[
                  ...
                  <label key={field} className={field === 'fullName' ? 'space-y-1 sm:col-span-2' : 'space-y-1'}>
                    <span className="text-[9px] font-black uppercase tracking-widest text-slate-400">{label} <b className="text-rose-500">*</b></span>
                    <input
              ...
              <button
                ...
                disabled={saving}
                className="mt-3 flex w-full items-center justify-center gap-2 rounded-lg bg-indigo-600 px-4 py-3 text-[10px] font-black uppercase tracking-widest text-white shadow-md shadow-indigo-600/20 transition hover:bg-indigo-700 disabled:opacity-60"
              >
      ...
      <section className="rounded-xl border border-slate-100 bg-white p-3 shadow-sm">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mb-3">
          ...
          <label className="space-y-1">
            <span className="text-[9px] font-black uppercase tracking-widest text-slate-400">Arxiv oyi</span>
            <input
              type="month"
              value={archiveMonth}
