...
import { Users, Building2, TrendingUp, AlertTriangle, Plus, ShieldCheck } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        <KPICard title="Tizim reytingi" value="98%" icon={ShieldCheck} color="green" trend={{ value: 1.8, isUp: true }} />
        {[
