...
export const OperationsLog: React.FC = () => {
  ...
  return (
    <div className="bg-white/95 rounded-2xl border border-emerald-100 shadow-[0_18px_45px_rgba(6,78,59,0.06)] overflow-hidden">
      <div className="p-5 sm:p-6 border-b border-emerald-100 bg-gradient-to-r from-white to-emerald-50/50 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 sm:gap-6">
        <div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto">
          {/* Tabs */}
          <div className="flex bg-emerald-50 p-1 rounded-xl w-full sm:w-auto overflow-x-auto no-scrollbar border border-emerald-100">
            <button 
            ...
            {activeTab !== 'ARCHIVED' && activeTab !== 'INCOMING' && activeTab !== 'OUTGOING' && (
              <div className="relative flex-1 sm:flex-none min-w-[100px]">
                ...
                <select 
                  ...
                  className="pl-9 pr-8 py-2 bg-white border border-emerald-100 rounded-xl text-[10px] sm:text-xs font-bold outline-none focus:ring-2 focus:ring-brand-primary/10 appearance-none cursor-pointer w-full"
                >
      ...
      <div className="divide-y divide-slate-50 max-h-[500px] sm:max-h-[600px] overflow-y-auto custom-scrollbar">
        {loading ? (
          ...
          <div className="p-10 sm:p-20 text-center">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-emerald-50 rounded-full flex items-center justify-center mx-auto mb-4 border border-emerald-100">
              <History size={20} className="text-emerald-300 sm:w-6 sm:h-6" />
            </div>
