...
const KITCHEN_HYGIENE_REQUIREMENTS = [
  "Oshxona tozaligi tekshirildi",
  "Qo'llar yuvilgan va dezinfeksiya qilingan",
  "Tirnoqlar olingan",
  "Forma, fartuk va bosh kiyim toza",
  "Idish-tovoqlar sanitariya talabiga mos",
  "Xom va tayyor mahsulotlar alohida saqlanmoqda",
  "Mahsulotlarning yaroqlilik muddati tekshirildi",
  "Ish stollari va pichoqlar dezinfeksiya qilingan"
];
...
const KitchenManagerView: React.FC = () => {
  ...
  const hygieneRequirements = KITCHEN_HYGIENE_REQUIREMENTS;
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100">
                        ...
                        <div className="flex items-center gap-2 text-brand-depth font-black">
                          ...
                          <span>{task.temperature ? `${task.temperature}В°C` : '--'}</span>
                        </div>
                      </div>
                      <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100">
            ...
            {tasks.length === 0 && (
              <div className="col-span-full py-20 bg-white rounded-[4rem] border-2 border-dashed border-brand-border flex flex-col items-center justify-center text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-brand-muted mt-1 uppercase tracking-widest">Menyu kiritilishini kuting</p>
                </div>
              </div>
            )}
          </div>
