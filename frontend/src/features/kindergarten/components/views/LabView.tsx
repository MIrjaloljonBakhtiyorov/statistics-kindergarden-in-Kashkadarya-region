  ...
  return (
    <div className="p-8 space-y-10 animate-in fade-in duration-700 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-6">
        <div>
          <h2 className="text-4xl font-black text-brand-depth tracking-tight">Tayyor taomlar brokeraj daftari</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        {[
          { label: 'Jami Sinamalar', value: stats.total, sub: '24 soatlik baza', color: 'text-brand-depth', icon: Database, bg: 'bg-slate-50' },
        ...
        <div className="xl:col-span-8 space-y-8">
          <AnimatePresence mode="wait">
            ...
            {activeTab === 'ENVIRONMENT' && (
              ...
              >
                {[
                  { name: 'Muzlatgich-01 (Sinamalar)', temp: '3.4В°C', hum: '45%', status: 'STABLE', icon: Thermometer, color: 'text-blue-500' },
                  { name: 'Muzlatgich-02 (Go\'sht)', temp: '-18.2В°C', hum: '30%', status: 'STABLE', icon: Thermometer, color: 'text-indigo-500' },
                  { name: 'Laboratoriya Xonasi', temp: '22.5В°C', hum: '55%', status: 'STABLE', icon: Droplets, color: 'text-emerald-500' },
                  { name: 'Inkubator-A', temp: '37.0В°C', hum: '60%', status: 'STABLE', icon: Activity, color: 'text-rose-500' }
                ].map((env, i) => (
           ...
           <div className="bg-brand-depth p-10 rounded-[3rem] text-white shadow-2xl relative overflow-hidden">
              ...
              <ul className="space-y-6 relative z-10">
                {[
                  ...
                  { text: 'Sinamalarni +2В°C dan +6В°C gacha haroratda saqlash.', color: 'bg-blue-400' },
                  { text: 'Saqlash muddati qat\'iy 24 soat (1 sutka).', color: 'bg-amber-400' },
                ...
                <div className="flex-1 overflow-y-auto p-12 space-y-12">
                   ...
                   <div className="bg-slate-50 p-10 rounded-[3rem] space-y-8">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-[10px] font-black text-emerald-600 uppercase">Standart: +2В°C / +6В°C</span>
                      </div>
                      ...
                      <div className="flex justify-between text-[8px] font-black text-brand-muted uppercase px-2">
                        ...
                        <span>24 soat (Utilizatsiya)</span>
                      </div>
                   </div>
