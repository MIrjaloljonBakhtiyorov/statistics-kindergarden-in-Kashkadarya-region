        ...
        <div className="mb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-2 bg-slate-100 px-3 py-1.5 rounded-lg mb-3">
              ...
              <span className="text-[11px] font-semibold text-slate-600 uppercase tracking-widest">{t('stats.types')}</span>
            </div>
            <h3 className="text-2xl font-bold text-[#003580] uppercase leading-tight">{t('stats.title')}</h3>
          </div>
          ...
          {kindergartenTypes.map((type, index) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-[12px] font-semibold text-slate-700 leading-snug">{t(type.name)}</p>
      ...
      <div className="grid grid-cols-1 gap-6">
          ...
          <div className="relative z-10 mb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              <div className="inline-flex items-center gap-2 bg-slate-100 px-3 py-1.5 rounded-lg mb-3">
                ...
                <span className="text-[11px] font-semibold text-slate-600 uppercase tracking-widest">{t('region.byMttTypes')}</span>
              </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="relative rounded-[2rem] overflow-hidden shadow-2xl">
              <img
                ...
                alt={t('region.preschoolSystem')}
                style={{ width: '100%', height: 'auto', display: 'block' }}
              />
              <div className="absolute inset-0 bg-gradient-to-r from-[#0a2010]/75 via-[#0a2010]/20 to-transparent" />
              <div className="absolute inset-0 flex items-center px-8">
                <div>
                  <p className="text-[11px] font-bold text-green-300 uppercase tracking-widest mb-2">{t('region.goal')}</p>
                  <h3 className="text-[24px] font-black text-white leading-tight max-w-xs">
                    {t('region.coverageGoalPrefix')} <span className="text-green-300">90%</span>{t('region.coverageGoalSuffix')}
                  </h3>
                </div>
              </div>
            </div>
              ...
              <div className="absolute inset-0 flex items-center px-8">
                <div className="max-w-xs">
                  <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-[10px] font-bold text-white uppercase tracking-widest bg-white/15 border border-white/25 mb-3">
                    ...
                    {t('region.preschoolSystem')}
                  </span>
                  <h2 className="text-[22px] font-black text-white leading-tight mb-2">
                    {t('region.eachChild')} <span className="text-green-300">{t('region.stateCare')}</span> {t('region.underCare')}
                  </h2>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
            {[
              { src: "https://data.daryo.uz/media/2019/06/cb53393f-5e8f-1bca-ec10-3f63a339d103.jpg", label: t('region.photoTalk') },
              { src: "https://xabar.uz/static/crop/4/8/920__95_482040167.jpg", label: t('region.photoOpening') },
              { src: "https://xabar.uz/static/crop/3/5/920__95_3585833392.jpg", label: t('region.photoModern') },
              { src: "https://xabar.uz/static/crop/3/3/920__95_330319174.jpg", label: t('region.photoTeachers') },
            ].map((item, i) => (
              <motion.div
                key={i}
        ...
        <div className="bg-white p-6 md:p-10 rounded-[2.5rem] border border-slate-200 relative overflow-hidden shadow-sm">
            ...
            <div className="relative z-10 flex flex-col xl:flex-row xl:items-start justify-between gap-6 mb-8">
              <div className="max-w-xl">
                ...
                <h3 className="text-2xl md:text-4xl font-black text-black tracking-tighter uppercase mb-4 leading-none">{t('region.systematic')} <span className="text-indigo-600 italic">{t('region.control')}</span></h3>
              ...
              <div className="bg-slate-50 p-4 rounded-[2rem] border border-slate-100 shadow-inner flex flex-col items-center gap-1 shrink-0">
                <p className="text-[9px] font-black text-black uppercase tracking-[0.1em]">{t('region.dailyTotalCost')}</p>
<p className="text-xl font-black tracking-tighter text-[#003580]">1.28 <span className="text-sm text-black uppercase">{t('common.billion')}</span></p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
              {[
                { label: t('region.beforeNine'), value: '192,405', sub: t('common.childrenShort'), icon: Clock, color: 'text-emerald-600', bg: 'bg-emerald-50' },
                { label: t('region.afterNine'), value: '12,580', sub: t('common.childrenShort'), icon: Activity, color: 'text-amber-600', bg: 'bg-amber-50' },
                { label: t('region.absent'), value: '38,916', sub: t('common.childrenShort'), icon: Users, color: 'text-rose-600', bg: 'bg-rose-50' },
                { label: t('region.perChildCost'), value: '27,600', sub: t('common.sum'), icon: Wallet, color: 'text-indigo-600', bg: 'bg-indigo-50' },
              ].map((item, i) => (
               ...
               <div className="flex flex-col min-h-[680px]">
                  ...
                  <div className="bg-white flex-1 flex flex-col gap-4 p-6">
                    ...
                    <div className="grid grid-cols-3 gap-2 pt-1">
                      {[
                        { label: t('region.covered'), value: "243,901" },
                        { label: t('stats.totalMTT'), value: "4,439"   },
                        { label: t('region.coveragePercent'), value: "71.44%"  },
                      ].map((s, i) => (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div className="rounded-xl p-5 relative overflow-hidden" style={{background:'rgba(255,255,255,0.07)',border:'1px solid rgba(255,255,255,0.1)'}}>
                      ...
                      <p className="text-[10px] text-[#4ADE80] mt-1 font-semibold">
                        {(totalRegionalDailyCost/plannedDailyCost*100).toFixed(1)}% {t('region.spent')}
                      </p>
                    </div>
                    ...
                    <div className="rounded-xl p-5 relative overflow-hidden" style={{background:'rgba(255,255,255,0.07)',border:'1px solid rgba(255,255,255,0.1)'}}>
                      ...
                      <p className="text-[10px] text-amber-300 mt-1 font-semibold">
                        {(savedDailyCost/plannedDailyCost*100).toFixed(1)}% {t('region.saved')}
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="px-6 pt-7 pb-4 shrink-0 border-b border-slate-100">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <h4 className="text-[18px] font-black text-slate-900 leading-tight">{t('region.savedFunds')}</h4>
                        </div>
                    ...
                    <div className="relative z-10 px-5 pt-3 pb-3 shrink-0">
                      ...
                      <div className="grid grid-cols-3 gap-2 mt-3">
                        {[
                          ...
                          { label: t('footer.districts'), val: `${districts.length} ${t('common.countUnit')}`, accent: "#60a5fa", bg: "rgba(96,165,250,0.08)", br: "rgba(96,165,250,0.15)" },
                          { label: t('region.efficiency'), val: "38.2%", accent: "#fbbf24", bg: "rgba(251,191,36,0.08)", br: "rgba(251,191,36,0.15)" },
                        ].map((k, i) => (
                    ...
                    <div className="relative z-10 flex items-center justify-between px-5 pt-5 pb-4 shrink-0 border-b" style={{ borderColor: "#f1f3f8" }}>
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          ...
                          <p className="text-[15px] font-black text-slate-900 leading-tight tracking-tight">{t('region.monitoringForecast')}</p>
                        </div>
                      </div>
