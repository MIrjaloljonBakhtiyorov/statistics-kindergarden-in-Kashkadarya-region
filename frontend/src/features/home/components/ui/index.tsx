...
import type { SectionProps, CardProps, SectionHeadProps, ButtonVariant, ButtonSize } from "../../../../shared/types";

// ─── UI COMPONENTS ────────────────────────────────────────────────────────────

// 1. Container — viewportning 90% kengligi, chap/o'ngdan 5% joy
export function Container({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    <div className={`mx-auto w-[90%] ${className}`}>
      {children}
    </div>
  );
}
