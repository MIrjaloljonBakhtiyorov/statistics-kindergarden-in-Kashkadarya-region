      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <p className="text-slate-600 text-sm leading-relaxed">{t('footer.description')}</p>
          ...
          <div>
            <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest mb-6">{t('footer.contact')}</h3>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-indigo-500 shrink-0" />
                <span className="text-slate-600 text-sm">{t('footer.address')}</span>
              </li>
          ...
          <div>
            <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest mb-6">{t('footer.links')}</h3>
            <ul className="space-y-3">
              {footerLinks.map((item) => (
                <li key={item}>
                  <a href="#" className="text-slate-600 text-sm hover:text-indigo-600 transition-colors">{t(item)}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            <h3 className="text-sm font-black text-slate-900 uppercase tracking-widest mb-6">{t('footer.newsletter')}</h3>
            <p className="text-slate-600 text-sm mb-4">{t('footer.newsletterText')}</p>
        ...
        <div className="pt-8 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-8">
            <a href="#" className="text-slate-400 text-xs font-bold hover:text-slate-600 uppercase tracking-wider transition-colors">{t('footer.privacy')}</a>
            <a href="#" className="text-slate-400 text-xs font-bold hover:text-slate-600 uppercase tracking-wider transition-colors">{t('footer.terms')}</a>
          </div>
        </div>
      </div>
    </footer>
