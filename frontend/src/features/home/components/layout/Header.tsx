...
const Header: React.FC<HeaderProps> = ({
  ...
  const handleNavigation = (path: string) => {
    if (path.startsWith('/admin') || path.startsWith('/kindergarten') || path.startsWith('/stats')) {
  ...
  const getShortName = (code: string) => {
    if (code === 'uz-lat') return 'UZ';
    if (code === 'uz-cyr') return 'UZ-K';
          ...
          <div className="p-4 grid grid-cols-1 gap-2">
            ...
            <div className="mt-4 pt-4 border-t border-slate-100 flex flex-col gap-2">
              ...
              >
                ...
                <span className="text-indigo-600">{getShortName(currentLang)}</span>
              </button>
