        ...
        <div className="flex-1 p-8 md:p-20 flex flex-col justify-center space-y-12">
          ...
          >
            <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100 space-y-4 hover:shadow-xl transition-all group">
              ...
              <div>
                <p className="font-black text-slate-900 text-xs uppercase tracking-widest">{t('welcome.fastAnalytics')}</p>
            ...
            <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100 space-y-4 hover:shadow-xl transition-all group">
              ...
              <div>
                <p className="font-black text-slate-900 text-xs uppercase tracking-widest">{t('welcome.safeSystem')}</p>
                <p className="text-[10px] text-slate-400 font-bold uppercase mt-1">{t('welcome.highSecurity')}</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <span className="relative z-10 flex items-center gap-4">
              {t('welcome.enter')} <MousePointer2 className="w-6 h-6 animate-bounce" />
            </span>
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <p className="font-black text-sm uppercase tracking-widest text-indigo-300">{t('welcome.innovation')}</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">{t('welcome.version')} 2.0 &bull; 2026</p>
              </div>
            </div>
          </div>
