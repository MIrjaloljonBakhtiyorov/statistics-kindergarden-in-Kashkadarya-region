      ...
      <div style={{
        ...
        <div style={{ padding: '14px 16px 10px', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
            ...
            <span style={{ fontSize: 9, fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.18em', color: isCity ? '#60a5fa' : '#34d399' }}>
              {isCity ? t('modal.city') : t('modal.district')}
            </span>
          </div>
        ...
        <div style={{ padding: '10px 16px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 10 }}>
            {[
              { icon: School, label: t('modal.mtts'), value: mttCount, accent: '#818cf8' },
              { icon: TrendingUp, label: t('modal.coverage'), value: `${coverage}%`, accent: '#34d399' },
              { icon: Users, label: t('modal.age3to7'), value: children.toLocaleString(), accent: '#60a5fa' },
              { icon: Users, label: t('modal.covered'), value: covered.toLocaleString(), accent: '#f472b6' },
            ].map((s, i) => (
