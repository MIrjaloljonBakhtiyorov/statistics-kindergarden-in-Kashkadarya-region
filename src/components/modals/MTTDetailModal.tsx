      ...
      {selectedMTTType && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-6 md:p-12 pointer-events-none">
          ...
          <motion.div 
            ...
            className="relative bg-white w-[52vw] max-h-[70vh] rounded-none shadow-[0_50px_100px_-20px_rgba(0,0,0,0.4)] overflow-hidden pointer-events-auto border border-white/20 flex flex-col"
          >
