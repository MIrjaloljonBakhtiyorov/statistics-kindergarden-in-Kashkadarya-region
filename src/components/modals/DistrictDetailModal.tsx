...
import { 
  ...
  Image as ImageIcon, MapPin, BarChart3, AlertCircle,
  LayoutGrid, Info, Target, ShieldCheck, Zap
} from 'lucide-react';
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[2000] flex items-center justify-center p-4 md:p-8">
        ...
        <motion.div
          ...
          className="relative bg-white w-[52vw] h-[70vh] rounded-[1%] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] overflow-hidden border border-white/10 flex flex-col md:flex-row"
        >
                  ...
                  <>
                    ...
                    <section>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                        {[
                          { label: '3-7 Yoshli Bolalar', value: details.totalChildren3to7, icon: Baby, color: 'text-blue-500', bg: 'bg-blue-50' },
                          { label: 'Qamrab Olingan', value: details.totalCoveredChildren, icon: Users, color: 'text-emerald-500', bg: 'bg-emerald-50' },
                          { label: 'Muassasalar', value: details.totalMTT, icon: School, color: 'text-purple-500', bg: 'bg-purple-50' }
                        ].map((stat, i) => (
                          <div key={i} className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm hover:shadow-lg transition-all duration-300">
                            ...
                            <p className="text-2xl font-black text-slate-900 tracking-tighter mb-1">{stat.value.toLocaleString()}</p>
