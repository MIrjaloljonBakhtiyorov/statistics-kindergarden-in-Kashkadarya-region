...
const KindergartenController = {
    ...
    getAlerts: async (req, res) => {
        ...
        `),
            ...
            const existingKindergartenCreateIds = new Set(eventRows
            ...
            const alerts = [...eventAlerts, ...medicalAlerts, ...kindergartenAlerts, ...menuAlerts].sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime());
